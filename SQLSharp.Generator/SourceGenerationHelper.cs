...
[assembly: InternalsVisibleTo("SQLSharpGeneratorTests")]
...
internal static class SourceGenerationHelper
{
    ...
    internal const string RenameEnum =
        """
        // <auto-generated/>
        #nullable enable
    ...
    internal const string FromRowAttribute =
        """
        // <auto-generated/>
        #nullable enable
    ...
    internal const string ColumnAttribute =
        """
        // <auto-generated/>
        #nullable enable
    ...
    internal static string GenerateRowParserPartialClass(
    ...
    internal static string GetFullNamespaceName(this INamespaceSymbol namespaceSymbol)
    {
    ...
    internal const string WrapperTypeAttribute =
        """
        // <auto-generated/>
        #nullable enable
    ...
    internal static string GenerateWrapperDecode(
        ...
        SourceProductionContext sourceProductionContext)
    {
        ...
        var extractionMethodSuffix = wrapperTypeToGenerate.InnerValue.IsNullable ? string.Empty : "NotNull";
        var nullability = wrapperTypeToGenerate.InnerValue is { IsNullable: true, IsRefType: false }
                ? "?"
                : string.Empty;
        var initialization = wrapperTypeToGenerate.HasNonDefaultConstructor
            ? $"return new {wrapperTypeToGenerate.Name}(row.GetField{extractionMethodSuffix}<{wrapperTypeToGenerate.InnerValue.TypeName}{nullability}>(column));"
            : $$"""
                return new {{wrapperTypeToGenerate.Name}}
                        {
                            {{wrapperTypeToGenerate.InnerValue.Name}} = row.GetField{{extractionMethodSuffix}}<{{wrapperTypeToGenerate.InnerValue.TypeName}}{{nullability}}>(column)
                        };
                """;
        return
            $$"""
    ...
    internal static string? GetDbType(string parameter)
    {
